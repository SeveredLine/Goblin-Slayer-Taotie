<template>
  <div class="flex h-full flex-col bg-[#1e1b18]">
    ...
    <div class="flex border-b border-[#4a3e35] bg-[#121010]">
      ...
      >
        ...
        <div
          ...
          class="absolute bottom-0 left-0 h-0.5 w-full bg-[#c59d5f] shadow-[0_0_10px_#c59d5f]"
        ></div>
      </button>
    </div>
    ...
    <div class="relative flex-1 overflow-hidden p-1">
      <!-- 背景纹理 -->
      <div
        class="pointer-events-none absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/parchment.png')] opacity-10"
      ></div>
